...
object ZWaveApi {
  ...
  def getLightingSummary(): ApiRequest[LightingSummary] =
    ApiRequest[LightingSummary](ApiMethods.GET, "https://virtserver.swaggerhub.com/ZachT1711/Zach/1.0.0", "/lightingSummary", "application/json")
  ...
  def getSwitchState(deviceId: String): ApiRequest[DeviceState] =
    ApiRequest[DeviceState](ApiMethods.GET, "https://virtserver.swaggerhub.com/ZachT1711/Zach/1.0.0", "/lighting/switches/{deviceId}", "application/json")
  ...
  def setDimmer(deviceId: String, value: Int): ApiRequest[ApiResponse] =
    ApiRequest[ApiResponse](ApiMethods.POST, "https://virtserver.swaggerhub.com/ZachT1711/Zach/1.0.0", "/lighting/dimmers/{deviceId}/{value}", "application/json")
      .withPathParam("deviceId", deviceId)
  ...
  def setDimmerTimer(deviceId: String, value: Int, timeunit: Int, units: Option[String]): ApiRequest[ApiResponse] =
    ApiRequest[ApiResponse](ApiMethods.POST, "https://virtserver.swaggerhub.com/ZachT1711/Zach/1.0.0", "/lighting/dimmers/{deviceId}/{value}/timer/{timeunit}", "application/json")
  ...
  def setSwitch(deviceId: String, value: String): ApiRequest[ApiResponse] =
    ApiRequest[ApiResponse](ApiMethods.POST, "https://virtserver.swaggerhub.com/ZachT1711/Zach/1.0.0", "/lighting/switches/{deviceId}/{value}", "application/json")
      .withPathParam("deviceId", deviceId)
      .withPathParam("value", value)
      .withSuccessResponse[ApiResponse](200)
        /**
  ...
  def setSwitchTimer(deviceId: String, value: String, minutes: Int): ApiRequest[ApiResponse] =
    ApiRequest[ApiResponse](ApiMethods.POST, "https://virtserver.swaggerhub.com/ZachT1711/Zach/1.0.0", "/lighting/switches/{deviceId}/{value}/timer/{minutes}", "application/json")
      .withPathParam("deviceId", deviceId)
      .withPathParam("value", value)
